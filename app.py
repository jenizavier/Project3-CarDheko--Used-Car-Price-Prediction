# -*- coding: utf-8 -*-
"""
Created on Thu Aug 22 21:46:04 2024
...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 22 15:19:16 2024
...
model = joblib.load('E:/GUVI/PROJECT 3 CARDHEKO/DATASET/tuned_gradient_boosting_model.pkl')
...
engine_type_num = engine_type_map[engine_type]

# Convert city to numerical value (make sure this matches how the model was trained)
city_map = {'Chennai': 0, 'Kolkata': 1, 'Bangalore': 2,'Hyderabad': 3,'Jaipur': 4}  # Example encoding, adjust as needed
